...
![Version](https://img.shields.io/badge/version-7.2-blue?style=for-the-badge&color=00aacc)
...
<details>
<summary><h2>⬡ 𝗔𝗯𝗼𝘂𝘁 𝗡𝗘𝗞𝗢</h2></summary>
...
- **Persistent History** – Keeps context of chat if used with persistence flags. Chat history is saved in `~/neko/chat.json` and pentest history in `~/neko/pentest.json`
...
<details>
<summary><h2>⟢ Installation .ᐟ</h2></summary>
